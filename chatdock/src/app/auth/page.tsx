    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181826] via-[#2d1836] to-[#0a0a23] px-4">
      <div className="w-full max-w-md bg-white/5 backdrop-blur-lg rounded-2xl shadow-2xl border border-pink-400/20 p-8 sm:p-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <button className="flex items-center justify-center gap-3 w-full py-2.5 rounded-lg bg-[#181826] border border-pink-400/30 hover:border-pink-400 text-white font-semibold shadow transition-all hover:scale-105">
          ...
          <button className="flex items-center justify-center gap-3 w-full py-2.5 rounded-lg bg-[#181826] border border-purple-400/30 hover:border-purple-400 text-white font-semibold shadow transition-all hover:scale-105">
