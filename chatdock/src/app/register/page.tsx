    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181826] via-[#2d1836] to-[#0a0a23] px-4">
      <div className="w-full max-w-md bg-white/5 backdrop-blur-lg rounded-2xl shadow-2xl border border-pink-400/20 p-8 sm:p-10 flex flex-col gap-6">
        <div className="text-center">
          ...
          <p className="text-gray-300 text-sm">Sign up for ChatDock</p>
        </div>
        ...
        {success && (
          <div className="bg-green-900/60 text-green-300 text-sm rounded p-2 text-center">{success}</div>
        )}
        ...
        <form className="flex flex-col gap-4" onSubmit={handleRegister}>
          ...
          <div>
            <label className="block text-sm font-medium text-purple-300 mb-1">Confirm Password</label>
            <div className="relative">
              <input
                name="confirm"
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-purple-600 hover:to-pink-500 text-white font-bold py-2.5 rounded-lg shadow-lg transition-all hover:scale-105 disabled:opacity-60"
          >
        ...
        <div className="text-center mt-2">
          ...
          <a href="/auth" className="text-pink-400 hover:underline hover:text-purple-400 transition text-xs font-semibold">
            Login
          </a>
        </div>
      </div>
